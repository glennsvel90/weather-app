...
tabControl.add(tab2, text='NOAA')       # Add the tab

tab3 = ttk.Frame(tabControl)                # Add a second tab
tabControl.add(tab3, text='Station IDs')    # Make second tab visible
...
# We are creating a container frame to hold other widgets
weather_cities_frame = ttk.LabelFrame(tab2, text=' Latest Observation for ')
...
#######
# We are creating a container frame to hold all other widgets
weather_states_frame = ttk.LabelFrame(tab3, text=' Weather Station IDs ')
